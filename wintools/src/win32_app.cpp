...
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_erase), state);
	...
	if (old_tool == & ogl_view::tool_edit)
	{
		toggle_event_ignore_counter++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_edit), state);
	}
...
void win_app::maintb_tool_Edit(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "erase skipped ; counter = " << toggle_event_ignore_counter << endl;
	...
	{*/
		cout << "edit state is mtb_mtool_erase" <<  endl;
//			win_toggle_tool_button_get_active(win_TOGGLE_TOOL_BUTTON(mtb_mtool_erase)) <<
		
		mouse_tool * old_tool = ogl_view::current_tool;
		ogl_view::current_tool = & ogl_view::tool_edit;
		HandleToggleButtons(old_tool);
//	}
}
...
static int toggle_event_ignore_counter_gdi = 0;
void win_app::HandleToggleButtons_gdi(mouse_gdiplus_tool * old_tool)
{
	// a static event counter is set up and used so that a cascade of button events is prevented.
	// the same thing could be done by disabling/enabling the callbacks in GTK, but this is simpler.
	
	bool state = TRUE;
	if (old_tool != gdiplus_view::current_gdiplus_tool) state = FALSE;
	
	if (old_tool == & gdiplus_view::tool_draw)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_draw), state);
	}
	
	if (old_tool == & gdiplus_view::tool_erase)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_erase), state);
	}
	
	if (old_tool == & gdiplus_view::tool_edit)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_edit), state);
	}
	
	if (old_tool == & gdiplus_view::tool_select)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_select), state);
	}
	
	if (old_tool == & gdiplus_view::tool_zoom)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_zoom), state);
	}
	
/*	if (old_tool == & gdiplus_view::tool_clipping)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_clipping), state);
	}*/
	
	if (old_tool == & gdiplus_view::tool_translate_xy)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_transl_xy), state);
	}
	
/*	if (old_tool == & gdiplus_view::tool_translate_z)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_transl_z), state);
	}*/
	
/*	if (old_tool == & gdiplus_view::tool_orbit_xy)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_orbit_xy), state);
	}*/
	
/*	if (old_tool == & gdiplus_view::tool_orbit_z)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_orbit_z), state);
	}*/
	
/*	if (old_tool == & gdiplus_view::tool_rotate_xy)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_rotate_xy), state);
	}*/
	
/*	if (old_tool == & gdiplus_view::tool_rotate_z)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_rotate_z), state);
	}*/
	
	if (old_tool == & gdiplus_view::tool_measure)
	{
		toggle_event_ignore_counter_gdi++;
//		gtk_toggle_tool_button_set_active(GTK_TOGGLE_TOOL_BUTTON(mtb_mtool_measure), state);
	}
...
void win_app::gditb_tool_Draw(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "draw skipped ; counter = " << toggle_event_ignore_counter << endl;
	...
	{*/
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_draw;
		HandleToggleButtons_gdi(old_tool);
//	}
}

void win_app::gditb_tool_Erase(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "erase skipped ; counter = " << toggle_event_ignore_counter << endl;
...
//			win_toggle_tool_button_get_active(win_TOGGLE_TOOL_BUTTON(mtb_mtool_erase)) <<
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_erase;
		HandleToggleButtons_gdi(old_tool);
//	}
}

void win_app::gditb_tool_Edit(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "erase skipped ; counter = " << toggle_event_ignore_counter << endl;
...
//			win_toggle_tool_button_get_active(win_TOGGLE_TOOL_BUTTON(mtb_mtool_erase)) <<
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_edit;
		HandleToggleButtons_gdi(old_tool);
//	}
}
void win_app::gditb_tool_Select(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "select skipped ; counter = " << toggle_event_ignore_counter << endl;
	...
	{*/
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_select;
		HandleToggleButtons_gdi(old_tool);
//	}
}

void win_app::gditb_tool_Zoom(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "zoom skipped ; counter = " << toggle_event_ignore_counter << endl;
	...
	{*/
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_zoom;
		HandleToggleButtons_gdi(old_tool);
//	}
}

void win_app::gditb_tool_TranslXY(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "transl_xy skipped ; counter = " << toggle_event_ignore_counter << endl;
	...
	{*/
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_translate_xy;
		HandleToggleButtons_gdi(old_tool);
//	}
}

void win_app::gditb_tool_Measure(void * p1, UINT p2, HWND p3)
{
/*	if (toggle_event_ignore_counter > 0)
	{
		cout << "measure skipped ; counter = " << toggle_event_ignore_counter << endl;
	...
	{*/
		...
		mouse_gdiplus_tool * old_tool = gdiplus_view::current_gdiplus_tool;
		gdiplus_view::current_gdiplus_tool = & gdiplus_view::tool_measure;
		HandleToggleButtons_gdi(old_tool);
//	}
}
