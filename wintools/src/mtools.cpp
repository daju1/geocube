...
void edit_tool::ButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	latest_x = x; latest_y = y;
...
void edit_tool::MotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL) gv->cam->RenderWindow(gv, camera::EditMotion, x, y);
...
{
//printf("translate_xy_tool::ButtonEvent x = %d y = %d\n",x,y);
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		if (ogl_view::state == mouse_tool::Down)
...
{
//printf("translate_xy_tool::MotionEvent x = %d y = %d\n",x,y);
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		fGL dist[3] = { 0.0, 0.0, 0.0 };
		if (gv && gv->GetProject() && ref_to_object && tdata)
		{
			...
			else
			{
				...
				{
					gv->GetProject()->UpdateAllGraphicsViews();
				}
			}
		}
	}
...
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
//printf("translate_z_tool::ButtonEvent x = %d y = %d gv = %x\n",x,y, gv);
	if (gv != NULL)
	{
		if (ogl_view::state == mouse_tool::Down)
		{
...
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
//printf("translate_z_tool::MotionEvent x = %d y = %d gv = %x\n",x,y, gv);
	if (gv != NULL)
	{
//printf("translate_z_tool::MotionEvent gv != NULL\n");
		fGL dist[3] = { 0.0, 0.0, 0.0 };
		if (gv && gv->GetProject() && ref_to_object && tdata)
		{
//printf("translate_z_tool::MotionEvent (gv && gv->GetProject() && ref_to_object && tdata)\n");
			dist[2] = dist_sensitivity * gv->range[1] * (fGL) (latest_y - y) / (fGL) gv->size[1];
			ref_to_object->TranslateObject(dist, tdata);
...
transformer key_tool::tool_transformer = transformer();
i32s key_tool::latest_x = NOT_DEFINED; i32s key_tool::latest_y = NOT_DEFINED;
fGL key_tool::ang_sensitivity = 180.0; fGL key_tool::dist_sensitivity = 2.0;

int key_tool::speed = 25;

key_tool::key_tool(void)
{
...
void key_zoom_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
//printf("zoom_key_tool::KeyButtonEvent x = %d y = %d\n",x,y);
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		if (gv->quick_update && gv && gv->GetProject() && gv->cam)
...
void key_zoom_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
//printf("zoom_key_tool::KeyMotionEvent x = %d y = %d\n",x,y);
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		fGL dist[3] = { 0.0, 0.0, 0.0 };
...
void key_clipping_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		if (gv->quick_update && gv && gv->GetProject() && gv->cam)
		{
			if (ogl_view::key_state == key_tool::key_state::KeyDown)
			{
				render = gv->render;
				accumulate = gv->accumulate;
...
void key_clipping_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_translate_xy_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
//printf("key_translate_xy_tool::KeyButtonEvent x = %d y = %d\n",x,y);
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		if (ogl_view::key_state == key_tool::key_state::KeyDown)
...
void key_translate_xy_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
//printf("key_translate_xy_tool::KeyMotionEvent oglv = 0x%08x x = %d y = %d\n",oglv,x,y);
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
		fGL dist[3] = { 0.0, 0.0, 0.0 };
...
void key_translate_z_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_translate_z_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_orbit_xy_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_orbit_xy_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_orbit_z_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_orbit_z_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_rotate_xy_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_rotate_xy_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_rotate_z_tool::KeyButtonEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
...
void key_rotate_z_tool::KeyMotionEvent(ogl_view * oglv, i32s x, i32s y)
{
	graphics_view * gv = dynamic_cast<graphics_view *>(oglv);
	if (gv != NULL)
	{
