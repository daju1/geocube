...
void dummy_object::OrbitObject(const fGL * ang, const camera & cam, int type)
{
	if (ol == NULL) return;
	...
	{
		//my version
		glRotatef(ang[0], 1.f, 0.f, 0.f);
		glRotatef(ang[1], 0.f, 1.f, 0.f);
		glRotatef(ang[2], 0.f, 0.f, 1.f);
	}
	else
	{
		//ghemical version
