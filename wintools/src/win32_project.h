...
#endif	// ENABLE_BONOBO
	HWND paned_widget; // родительское окно
	HWND GetWidget() {return paned_widget;}
	
	HWND notebook_widget;
...
/*	static void popup_FileClose(HWND, void*);
	...
	static void popup_UncheckSelection(HWND, void*);
	static void popup_UncheckUnselection(HWND, void*);
	static void popup_SelectionSetColor(HWND, void*);
	static void popup_SelectionSetColor_FromCurrentWellsSloj(HWND, void*);	
	static void popup_SelectionToGridData(HWND, void*);
	static void popup_Selection_With_CurrentWellsSloj_ToGridData(HWND, void*);
	static void popup_SelectionToLayer(HWND, void*);
	static void popup_CheckSelection(HWND, void*);
	static void popup_CheckUnselection(HWND, void*);
	static void popup_SelectionGetNamesAndID(HWND, void*);
	static void popup_SelectionSetName(HWND, void*);
	static void popup_SelectionSetID(HWND, void*);
	
	static void popup_SelectModeObject(HWND, void* data);
	static void popup_SelectModeObjectsSameID(HWND, void* data);	
	static void popup_SelectModeObjectsSameName(HWND, void* data);	
	static void popup_SelectModePoint(HWND, void* data);
	static void popup_SelectModeEdge(HWND, void* data);
	static void popup_SelectModeTriangle(HWND, void* data);
	static void popup_SelectModeQuad(HWND, void* data);
	static void popup_SelectModePolygon(HWND, void* data);
