...
/// This should set the window title text for this view.
	...
	virtual void CreateMyPopupMenu(HWND hWnd) = 0;
...
class project_view : virtual public view
{
	...
	virtual void MapViewAdded(map_view *) = 0;
	virtual void MapViewRemoved(map_view *) = 0;
...
{
	friend LRESULT CALLBACK WndSurfProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
	protected:
...
/// Size of the viewing window, in pixels.
	...
	static key_tool::key_state key_state;
	static key_tool::key key;

	static draw_tool::what_to_draw what_to_draw;
	static erase_tool::what_to_erase what_to_erase;
	static edit_tool::what_to_edit what_to_edit;
	...
	// all available key tools are here...
	// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	static key_zoom_tool key_tool_zoom;
	static key_clipping_tool key_tool_clipping;
	static key_translate_xy_tool key_tool_translate_xy;
	static key_translate_z_tool key_tool_translate_z;	
	static key_orbit_xy_tool key_tool_orbit_xy;
	static key_orbit_z_tool key_tool_orbit_z;	
	static key_rotate_xy_tool key_tool_rotate_xy;
	static key_rotate_z_tool key_tool_rotate_z;
...
class gdiplus_view : virtual public view
{
	friend LRESULT CALLBACK WndSurfProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
	protected:
...
/// Size of the viewing window, in pixels.
	...
	static mouse_gdiplus_tool::state state;
	static mouse_gdiplus_tool::button button;

	static key_gdiplus_tool::key_state key_state;
	static key_gdiplus_tool::key key;

	static draw_gdiplus_tool::what_to_draw what_to_draw;
	static erase_gdiplus_tool::what_to_erase what_to_erase;
	static edit_gdiplus_tool::what_to_edit what_to_edit;
	...
	static draw_gdiplus_tool tool_draw;
	static erase_gdiplus_tool tool_erase;
	static edit_gdiplus_tool tool_edit;
	
	static select_gdiplus_tool tool_select;
	static select_gdiplus_tool::select_mode select_mode;
	
	static zoom_gdiplus_tool tool_zoom;
	//static clipping_gdiplus_tool tool_clipping;
	
	static translate_xy_gdiplus_tool tool_translate_xy;
	//static translate_z_gdiplus_tool tool_translate_z;
	
	//static orbit_xy_gdiplus_tool tool_orbit_xy;
	//static orbit_z_gdiplus_tool tool_orbit_z;
	
	//static rotate_xy_gdiplus_tool tool_rotate_xy;
	//static rotate_z_gdiplus_tool tool_rotate_z;

	static measure_gdiplus_tool tool_measure;
	static measure_gdiplus_tool::measure_mode measure_mode;
	// all available key tools are here...
	// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
	static key_zoom_gdiplus_tool key_gdiplus_tool_zoom;
	static key_clipping_gdiplus_tool key_gdiplus_tool_clipping;
	static key_translate_xy_gdiplus_tool key_gdiplus_tool_translate_xy;
	static key_translate_z_gdiplus_tool key_gdiplus_tool_translate_z;	
	static key_orbit_xy_gdiplus_tool key_gdiplus_tool_orbit_xy;
	static key_orbit_z_gdiplus_tool key_gdiplus_tool_orbit_z;	
	static key_rotate_xy_gdiplus_tool key_gdiplus_tool_rotate_xy;
	static key_rotate_z_gdiplus_tool key_gdiplus_tool_rotate_z;
	
	friend class win_app;
	friend class project;
	friend class select_gdiplus_tool;
	friend class zoom_gdiplus_tool;
	friend class clipping_gdiplus_tool;
	friend class translate_xy_gdiplus_tool;
	friend class translate_z_gdiplus_tool;
	friend class orbit_xy_gdiplus_tool;
	friend class orbit_z_gdiplus_tool;
	friend class rotate_xy_gdiplus_tool;
	friend class rotate_z_gdiplus_tool;
	friend class measure_gdiplus_tool;
	friend class win_project;
...
/// Pointer to the currently selected mouse tool.
	static mouse_gdiplus_tool * current_gdiplus_tool;
	static key_gdiplus_tool * current_key_gdiplus_tool;
	
	public:
	
	gdiplus_view(void);
	virtual ~gdiplus_view(void);
...
/// Dimensions of the view, in nanometers.
	...
	friend class key_zoom_tool;
	friend class key_clipping_tool;
	friend class key_translate_xy_tool;
	friend class key_translate_z_tool;
	friend class key_orbit_xy_tool;
	friend class key_orbit_z_tool;
	friend class key_rotate_xy_tool;
	friend class key_rotate_z_tool;

	friend class win_ogl_view;// my insert for mouse whell
...
class graphics_class_factory
{
	...
	virtual map_view * ProduceGDIMapView(project *, Object *, bool) = 0;
	virtual map_view * ProduceMapView(project *, Object *, bool) = 0;
