...
class camera : public dummy_object
{
	...
	enum rmode { Normal = 0, Draw = 1, Erase = 2, Edit = 3, Select = 4, Measure = 5, EditMotion = 6, ContextMotion = 7 };
...
*/
	...
	void OrbitObject(const fGL *, const camera &, int type);		// virtual
