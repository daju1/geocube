...
*/	
	...
	static void maintb_tool_Edit(void * p1, UINT p2, HWND p3);
	...
	static void HandleToggleButtons_gdi(mouse_gdiplus_tool *);

	static void gditb_tool_Draw(void * p1, UINT p2, HWND p3);
	static void gditb_tool_Erase(void * p1, UINT p2, HWND p3);
	static void gditb_tool_Edit(void * p1, UINT p2, HWND p3);
	static void gditb_tool_Select(void * p1, UINT p2, HWND p3);
	static void gditb_tool_Zoom(void * p1, UINT p2, HWND p3);
//	static void gditb_tool_Clipping(void * p1, UINT p2, HWND p3);
	static void gditb_tool_TranslXY(void * p1, UINT p2, HWND p3);
//	static void gditb_tool_TranslZ(void * p1, UINT p2, HWND p3);
//	static void gditb_tool_OrbitXY(void * p1, UINT p2, HWND p3);
//	static void gditb_tool_OrbitZ(void * p1, UINT p2, HWND p3);
//	static void gditb_tool_RotateXY(void * p1, UINT p2, HWND p3);
//	static void gditb_tool_RotateZ(void * p1, UINT p2, HWND p3);
	static void gditb_tool_Measure(void * p1, UINT p2, HWND p3);
