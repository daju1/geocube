...
void win_project_view::MapViewAdded(map_view *)
{
	cout << "called win_project_view::GDIplusViewAdded()" << endl;
}

void win_project_view::MapViewRemoved(map_view *)
{
	cout << "called win_project_view::GDIplusViewRemoved()" << endl;
}
