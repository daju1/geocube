...
void win_graphics_view::popup_ProjSterRedBlue(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
void win_graphics_view::popup_ProjSterRelaxed(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
void win_graphics_view::create_stereo_adj(gpointer data, float angrng)
{
...
void win_graphics_view::callback_distance(GtkAdjustment * adj, gpointer data)
{
	gtk_graphics_view * gv = GetGV((GtkWidget *) data);
...
void win_graphics_view::callback_angle(GtkAdjustment * adj, gpointer data)
{
	gtk_graphics_view * gv = GetGV((GtkWidget *) data);
...
void win_graphics_view::callback_destroy(HWND widget, void * data)
{
	gtk_graphics_view * gv = GetGV((GtkWidget *) data);
...
void win_graphics_view::scale_set_default_values(GtkScale *scale)
{
...
void win_graphics_view::popup_RenderQuickUpdate(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	gv->quick_update = !gv->quick_update;
}
/*
void win_graphics_view::popup_ViewsAttachDetach(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
*/
void win_graphics_view::popup_ViewsNewCam(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	gv->prj->AddGraphicsView(NULL, false);
}

void win_graphics_view::popup_ViewsNewView(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	gv->prj->AddGraphicsView(gv->cam, false);
}
/*
void win_graphics_view::popup_ViewsDeleteView(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
void win_graphics_view::popup_ViewsPushCRDSet(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
void win_graphics_view::popup_ViewsSuperimpose(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
*/
void win_graphics_view::popup_LightsNewLight(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
...
void win_graphics_view::popup_LightsNewLightLocDir(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	
	static const char command[] = "add light local directional";
	new command_dialog(gv->prj, gv, command);
}

void win_graphics_view::popup_LightsNewLightLocSpot(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	
	static const char command[] = "add light local spotlight";
	new command_dialog(gv->prj, gv, command);
}

void win_graphics_view::popup_LightsNewLightGlobDir(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	
	static const char command[] = "add light global directional";
	new command_dialog(gv->prj, gv, command);
}

void win_graphics_view::popup_LightsNewLightGlobSpot(HWND widget, void * data)
{
	win_graphics_view * gv = GetGV(widget);
	
	static const char command[] = "add light global spotlight";
	new command_dialog(gv->prj, gv, command);
}
