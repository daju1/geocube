...
BOOL IApplication::GridData(LPCTSTR DataFile, 
							...
							const VARIANT& ShowReport)
{
	...
	InvokeHelper(0x1e, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		DataFile, xCol, yCol, zCol, &ExclusionFilter, &DupMethod, &xDupTol, &yDupTol, &NumCols, &NumRows, &xMin, &xMax, &yMin, &yMax, &Algorithm, &ShowReport);
	return result;
}
