...
DBTableLito::DBTableLito(const char * tbnm) : DBTable (tbnm)
{

}

DBTableLito::~DBTableLito()
{

}

void DBTableLito::EnumCallBack(CRecordset * pRecordset)
{
	...
	if (this->lab_doc)
	{
		...
		{
			this->lab_doc->dll_w_project->Lito(id_kt, id_ige, h0, h1);
		}
	}
}
