// ExcelKTLabList.cpp: implementation of the ExcelKTLabList class.
//
//////////////////////////////////////////////////////////////////////
...
void ExcelKTLabList::InitExt()
{
	ext					= "ktl";
	xl_filter_name		= "Список выработок";
	xl_form				= "KTLabList";
}
bool ExcelKTLabList::virFill()
{
...
void ExcelKTLabList::virSaveToDB()
{
	...
	try
	{
		...
		this->m_lab_view->UpdateKTListCtrl(where, CLaboratoryView::str_kt_list_order_by);
	}
	catch (CDBException* pe) 
	{
		AfxMessageBox(pe->m_strError);
