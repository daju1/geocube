...
DBTableIGE::DBTableIGE(const char * tbnm) : DBTable (tbnm)
{

}

DBTableIGE::~DBTableIGE()
{

}
void DBTableIGE::EnumCallBack(CRecordset * pRecordset)
{
	...
	if (this->lab_doc)
	{
		...
		{
			this->lab_doc->dll_w_project->IGE(
				id_ige, id_gr,
				ige,
				mk, mkz,
				strat, desc0
