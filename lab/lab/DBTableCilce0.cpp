...
DBTableCilce0::DBTableCilce0(const char * tbnm) : DBTable (tbnm)
{

}

DBTableCilce0::~DBTableCilce0()
{

}
void DBTableCilce0::EnumCallBack(CRecordset * pRecordset)
{
	...
	if (this->lab_doc)
	{
		...
		{
			this->lab_doc->dll_w_project->Cilce0(
