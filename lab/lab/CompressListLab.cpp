// CompressListLab.cpp : implementation file
//
...
CompressListLab::CompressListLab()
{
}
...
BEGIN_MESSAGE_MAP(CompressListLab, CListCtrl)
	//{{AFX_MSG_MAP(CompressListLab)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CompressListLab::FillCtrlList(CRecordset * pRecordset)
{
...
void CompressListLab::DrawDataRow(CRecordset * pRecordset)
{
