...
KohonenMapWnd::KohonenMapWnd() : m_xPoints(NULL), m_yPoints(NULL), m_points(0), m_wayPoints(0), m_xWay(NULL), m_yWay(NULL)
{
}
...
void KohonenMapWnd::CreateNewMap(int points)
{
	...
	//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	char str[255];
	sprintf(str, "points = %d m_wayPoints = %d",points, m_wayPoints);
	MessageBox(0, str, "CreateNewMap", 0); 
	//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	// free old map
	Free();
...
// set way
//
void KohonenMapWnd::SetWay(double* xPoints, double* yPoints, short count)
{
	int		i;
